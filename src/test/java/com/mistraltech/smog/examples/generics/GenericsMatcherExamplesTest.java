...
import com.mistraltech.smog.examples.generics.matcher.MatcherFactory;
...
public class GenericsMatcherExamplesTest {
    ...
    public void testBoxMatcherSucceedsWhenMatches() {
        Matcher<Box<Integer>> matcher = is(MatcherFactory.<Integer>aBoxThat().hasContents(5));
    ...
    public void testBoxMatcherFailsWhenMismatches() {
        Matcher<Box<Integer>> matcher = is(MatcherFactory.<Integer>aBoxThat().hasContents(6));
    ...
    public void testBoxMatcherFailsForIncorrectInstanceType() {
        Matcher<Box<Integer>> matcher = is(MatcherFactory.<Integer>aBoxThat());
    ...
    public void testLabelledBoxMatcherSucceedsWhenMatches() {
        Matcher<LabelledBox<Integer, String>> matcher = is(MatcherFactory.<Integer, String>aLabelledBoxThat()
                .hasContents(42).hasLabel("Meaning Of Life"));
    ...
    public void testLabelledBoxMatcherFailsWhenMismatches() {
        Matcher<LabelledBox<Integer, String>> matcher = is(MatcherFactory.<Integer, String>aLabelledBoxThat().hasContents(42).hasLabel("My Age"));
    ...
    public void testLabelledBoxMatcherFailsForIncorrectTypeParam() {
        Matcher<LabelledBox<Integer, String>> matcher = is(MatcherFactory.<Integer, String>aLabelledBoxThat().hasContents(5).hasLabel("Meaning Of Life"));
